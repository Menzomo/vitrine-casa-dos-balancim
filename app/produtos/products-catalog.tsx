...
export function ProductsCatalog({ initialProducts, brands, initialSearch, initialBrand, initialCategory }: { initialProducts: Product[]; brands: string[]; initialSearch: string; initialBrand: string; initialCategory: string }) {
